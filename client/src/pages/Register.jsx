  ...
  return (
    <div className="min-h-screen p-6 lg:p-14">
      ...
      <div className="max-w-[400px] mx-auto bg-white p-6 md:p-10 shadow-md">
        ...
        <form>
          <div className="mb-10">
            <input className="input mb-4" placeholder="Name" type="text" />
            <input
          ...
          <div>
            ...
            <button
              type="button"
              className="flex items-center justify-center border border-border w-full mt-4 py-2 gap-3 cursor-pointer hover:shadow-md hover:bg-amber-50 active:bg-amber-100"
            >
          ...
          <div className="text-center mt-4">
            <p className="text-muted">
              ...
              <Link
                className="underline text-blue text-sm text-right"
                to="/login"
              >
                {" "}
                Login
